...
export async function generateMetadata({
  ...
  return localizedMetadata({ locale: typedLocale, path: "/consultation", title: page.seoTitle, description: page.seoDescription, image: "/media/consultation/consultation-02.webp" });
}
